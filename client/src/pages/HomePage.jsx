        ...
        <section className="bg-black py-16">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {/* Live Map */}
              <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 text-center hover:border-orange-500 transition-colors">
              ...
              {/* District Analytics */}
              <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 text-center hover:border-red-500 transition-colors">
              ...
              {/* Health Advisories */}
              <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 text-center hover:border-blue-500 transition-colors">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              >
                ...
                <div className="relative bg-cover bg-center rounded-2xl overflow-hidden mb-8" 
                  ...
                  {/* AQI Number and Status - Fixed spacing and layout */}
                  ...
                  {/* Status and Location - Positioned separately for better spacing */}
                  ...
                  {/* Enhanced Pollutant Levels - Better spacing and readability */}
                  {aqiData?.pollutants && (
